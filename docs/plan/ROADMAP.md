...
| Phase 4 GUI の作り込み | **一部着手** | プレビューに撮影日時とフォルダを出す（#41 完了）、人物の誕生日から年齢を計算（#48）、GUI の起動時に移行を実行（#52）。#48 と #52 はどちらも PR #51 でレビュー待ち。#41 と #48 は Phase 3 の手順2を楽にするため先行。残りは人物ごとの枚数表示、顔候補の推薦ほか | #18 |
